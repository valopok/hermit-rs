...
impl From<usize> for SysNvmeError {
	fn from(value: usize) -> Self {
		match value {
			...
			3 => SysNvmeError::NamespaceDoesNotExist,
			4 => SysNvmeError::MaxNumberOfQueuesReached,
			5 => SysNvmeError::CouldNotCreateIoQueuePair,
			6 => SysNvmeError::CouldNotDeleteIoQueuePair,
			7 => SysNvmeError::CouldNotFindIoQueuePair,
			8 => SysNvmeError::BufferIncorrectlySized,
			9 => SysNvmeError::CouldNotAllocateBuffer,
			10 => SysNvmeError::CouldNotDeallocateBuffer,
			11 => SysNvmeError::CouldNotReadFromIoQueuePair,
			12 => SysNvmeError::CouldNotWriteToIoQueuePair,
			13 => SysNvmeError::CouldNotClearNamespace,
